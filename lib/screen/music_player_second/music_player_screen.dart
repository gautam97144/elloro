...
class MusicPlayerScreenTwo extends StatefulWidget {
  ...
  @override
  _MusicPlayerScreenTwoState createState() => _MusicPlayerScreenTwoState();
}

class _MusicPlayerScreenTwoState extends State<MusicPlayerScreenTwo> {
        ...
        decoration: BoxDecoration(
            image: DecorationImage(
                image: CachedNetworkImageProvider(
                    "${widget.musicdata![widget.musicIndex!].image}"),
                fit: BoxFit.cover)),
                    ...
                    child: Row(
                      children: [
                        MyButton().tokenButton(
                          widget.tokenData != null &&
                                  widget.tokenData!.isNotEmpty
                              ? widget.tokenData![0].token.toString()
                              : "0",
                        ...
                        CircleAvatar(
                            backgroundImage: CachedNetworkImageProvider(
                                widget.tokenData != null &&
                                        widget.tokenData!.isNotEmpty
                                    ? widget.tokenData![0].profileImage
                                        .toString()
                                    : "")
  ...
  Widget bannerImage() {
    return CachedNetworkImage(
      ...
      imageUrl: widget.musicdata![widget.musicIndex!].image.toString(),
  ...
  Widget nameBanner() {
    return Expanded(
        child:
            //widget.musicdata![widget.musicIndex!].musicTitle!.length >= 28
            //     ? SizedBox(
            //         height: 40,
            //         child: Marquee(
            ...
            //           text: "${widget.musicdata?[widget.musicIndex!].musicTitle}",
            //         ),
            //       )
            //     :
            Text(
      "${widget.musicdata?[widget.musicIndex!].musicTitle}",
      style: CustomTextStyle.headline2,
      maxLines: 2,
      overflow: TextOverflow.ellipsis,
    )
        ...
        // Text(
        //   widget.musicdata![widget.musicIndex!].musicTitle.toString(),
        //   style: CustomTextStyle.headline2,
        //   maxLines: 1,
        //   overflow: TextOverflow.ellipsis,
        // ),
  ...
  Widget subTitleBanner() {
    return Expanded(
      child: Text(
        widget.musicdata![widget.musicIndex!].creatorName.toString()
            ...
            onTap: () {
              if ((widget.musicIndex!) > 0) {
                ...
                audioPlayer.play(
                    ...
                    widget.musicdata![widget.musicIndex!].path.toString());
              } else {
                widget.musicIndex = widget.musicdata!.length - 1;
        ...
        GestureDetector(
          onTap: () {
            if (isPlaying) {
              ...
              audioPlayer
                  .play(widget.musicdata![widget.musicIndex!].path.toString());
            }
            setState(() {
              isPlaying = !isPlaying;
            });
                ...
                return PopUp(
                  ...
                  child: Column(
                      ...
                      children: [
                            ...
                            children: [
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    widget.musicdata![widget.musicIndex!]
                                                .musicTitle!.length >=
                                            28
                                        ? Text(
                                            widget
                        ...
                        SizedBox(height: 2.h),
                        widget.musicdata![widget.musicIndex!].description!
                                    .length >=
                                512
                            ? Text(
                                widget
                                    .musicdata![widget.musicIndex!].description
                                    .toString()
                                    .substring(0, 512)
                        ...
                        Text(
                          "About ${widget.musicdata![widget.musicIndex!].creatorName
                        ...
                        widget.musicdata![widget.musicIndex!].creatorAbout!
                                    .length >=
                                512
                            ? Text(
                                widget
                                    .musicdata![widget.musicIndex!].creatorAbout
                                    .toString()
                                    .substring(0, 512)
                                // widget.catalogeListData?[widget.index!]
                                //         .creatorAbout ??
