...
class MusicPlayerScreenFour extends StatefulWidget {
  List<TokenModel>? tokenData;
  int? index;
  List<RecentAudioData>? catalogeListData;
  MusicPlayerScreenFour({
    Key? key,
  ...
  @override
  _MusicPlayerScreenFourState createState() => _MusicPlayerScreenFourState();
}

class _MusicPlayerScreenFourState extends State<MusicPlayerScreenFour> {
