class FavrouiteList {
  int? success;
  List<FavrouiteMusicList>? data;
  String? message;

  FavrouiteList({this.success, this.data, this.message});

  FavrouiteList.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    if (json['data'] != null) {
      data = <FavrouiteMusicList>[];
      json['data'].forEach((v) {
        data!.add(new FavrouiteMusicList.fromJson(v));
      });
    }
...
class FavrouiteMusicList {
  ...
  FavrouiteMusicList.fromJson(Map<String, dynamic> json) {
